...
import excel using ${data_external}/FY2020_Multispecies_Sector_ASM_Requirements_Summary.xlsx, sheet("table1") firstrow
...
clear
import excel using ${data_external}/FY2020_Multispecies_Sector_ASM_Requirements_Summary.xlsx, sheet("table2") firstrow
